...
COUNTRY_MACRO_KEYS = {
    "TW": ["TW_CPI", "TW_UNEMPLOYMENT", "TW_EXPORTS", "TW_M2", "TW_M1B", "TW_PMI", "TW_POLICY_RATE", "TW_FX_RESERVES", "TW_HOUSE_PRICE", "TW_TOURISM"],
    ...
    "CN": ["CN_M2", "CN_CPI", "CN_GDP"],
}

COUNTRIES = ["US", "TW", "JP", "SG", "CN"]
